...
if (isset($_POST['envoyer'])) {
  ...
  $statut = 0;
  $etat = 0;
  if (!empty($Libelle) && !empty($Montant) && !empty($Detail) && !empty($Categorie) && !empty($travailleur)) {
    $bdd->query("INSERT INTO depenses VALUES (null, '$Libelle', NOW(), '$Montant', '$Detail', '$Categorie', '$travailleur', '$statut', '$etat') ");
      ...
      <div class="modal-content rounded-5 shadow">
        ...
        <div class="modal-body p-5 pt-0">
          ...
          <form method="POST">
            ...
            <div class="form-floating mb-2">
              <input type="text" class="form-control rounded-4" id="floatingInput" name="Detail">
            ...
            <div class="form-floating mb-2">
              <select class=" form-control mb-2" name="Categorie">
                <?php
                $repChat =   $bdd->query("SELECT * from categoried");
                while ($tab = $repChat->fetch()) {
              ...
              <label> Categorie depenses</label>
            </div>
