 ...
 include 'connexionBd.php';
    ...
    if(isset($_POST['envoyer']))
    {
      ...
      if (!empty($numP)&& !empty($description))
       { 
        $bdd-> query("INSERT INTO vehicule(numP,description) VALUES('$numP','$description')");
       ...
       {
      $notification= "Completer la categorie de la dépense";
      }
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content rounded-5 shadow">
          <div class="modal-header p-5 pb-4 border-bottom-0">
            ...
            <h2 class="fw-bold mb-0">Vehicule</h2>
          ...
          <div class="modal-body p-5 pt-0">
            ...
            <form method="POST">
              <div class="form-floating mb-2">
                <input type="text" class="form-control rounded-4" id="floatingInput" name="numP">
                <label for="floatingInput">numP </label>
              </div>
              <div class="form-floating mb-2">
